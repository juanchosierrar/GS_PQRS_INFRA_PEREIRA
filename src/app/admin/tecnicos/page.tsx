...
export default function AdminTecnicosPage() {
    ...
    const tecnicos = useMemo(() => USUARIOS.filter(u => u.rol === 'TECNICO'), []);
    ...
    const depTecnicos = useMemo(() =>
        selectedDepId ? tecnicos.filter(t => t.dependenciaId === selectedDepId) : []
        , [selectedDepId, tecnicos]);
                            ...
                            <div className="grid md:grid-cols-2 gap-8">
                                ...
                                <div className="bg-zinc-900 rounded-[2.5rem] p-8 shadow-xl text-white">
                                    ...
                                    <div className="grid grid-cols-2 gap-6">
                                        <div className="space-y-1">
                                            <p className="text-4xl font-black italic tracking-tighter text-emerald-400">{depTecnicos.length}</p>
                                        ...
                                        <div className="space-y-1 border-l border-white/10 pl-6">
                                            <p className="text-4xl font-black italic tracking-tighter text-blue-400">
                                                {depTecnicos.filter(t => (allPqrs?.filter(p => p.asignadoA === t.id).length || 0) > 3).length}
                                            </p>
                                            <p className="text-[9px] font-black text-white/50 uppercase tracking-widest">Saturación Alta</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                {depTecnicos.map(tec => {
                                    ...
                                    return (
                                        ...
                                        >
                                            <div className="h-16 w-16 rounded-2xl bg-zinc-50 flex items-center justify-center text-xl font-black text-primary group-hover:bg-primary group-hover:text-white transition-all shadow-inner">
